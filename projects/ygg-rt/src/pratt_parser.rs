...
impl<R: YggdrasilRule> BitOr for Op<R> {
    type Output = Self;

    fn bitor(mut self, rhs: Self) -> Self {
        fn assign_next<R: YggdrasilRule>(op: &mut Op<R>, next: Op<R>) {
...
impl<R: YggdrasilRule> PrattParser<R> {
    ...
    pub fn new() -> Self {
        Self { prec: PREC_STEP, ops: BTreeMap::new(), has_prefix: false, has_postfix: false, has_infix: false }
    }
