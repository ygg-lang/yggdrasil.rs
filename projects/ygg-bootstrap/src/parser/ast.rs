...
mod peginator_generated {
    ...
    mod DefineStatement_impl {
        ...
        mod part_1 {
            ...
            pub fn parse<'a>(
                ...
                let ParseOk { state, .. } = parse_Whitespace(state, tracer, cache)?;
                let ok_result = parse_DefineNode(state, tracer, cache)?;
    ...
    mod DefineNode_impl {
        ...
        mod choice_1 {
            ...
            pub fn parse<'a>(
                ...
                let ok_result = parse_string_literal(state, "union")?;
                Ok(ok_result.map(|_| Parsed))
            }
            pub struct Parsed;
        }
        mod choice_2 {
            ...
            pub fn parse<'a>(
                ...
                let ok_result = parse_string_literal(state, "class")?;
                Ok(ok_result.map(|_| Parsed))
            }
            pub struct Parsed;
        }
        mod choice_3 {
            ...
            pub fn parse<'a>(
                ...
                let ok_result = parse_string_literal(state, "enum")?;
                Ok(ok_result.map(|_| Parsed))
            }
            pub struct Parsed;
        }
        mod choice_4 {
            ...
            pub fn parse<'a>(
                ...
                let ok_result = parse_string_literal(state, "struct")?;
                Ok(ok_result.map(|_| Parsed))
            }
            pub struct Parsed;
        }
        ...
        mod part_1 {
            ...
            mod closure {
                ...
                pub fn parse<'a>(
                    ...
                    let ParseOk { state, .. } = parse_Whitespace(state, tracer, cache)?;
                    let ok_result = parse_ExprStream(state, tracer, cache)?;
    ...
    mod ExprStream_impl {
        ...
        mod choice_0 {
            ...
            pub fn parse<'a>(
                ...
                Ok(ok_result.map(|result| Parsed { _override: Parsed__override::Prefix(result) }))
            }
            pub struct Parsed {
                pub _override: Parsed__override,
            }
        ...
        mod choice_1 {
            ...
            pub fn parse<'a>(
                ...
                Ok(ok_result.map(|result| Parsed { _override: Parsed__override::Suffix(result) }))
            }
            pub struct Parsed {
                pub _override: Parsed__override,
            }
        ...
        mod choice_2 {
            ...
            pub fn parse<'a>(
                ...
                let ParseOk { state, .. } = parse_Whitespace(state, tracer, cache)?;
                let ok_result = parse_Infix(state, tracer, cache)?;
                Ok(ok_result.map(|result| Parsed { _override: Parsed__override::Infix(result) }))
            }
            pub struct Parsed {
                pub _override: Parsed__override,
            }
    ...
    mod CharsetNode_impl {
        ...
        mod part_1 {
            ...
            mod optional {
                ...
                pub fn parse<'a>(
                    ...
                    let ParseOk { state, .. } = parse_Whitespace(state, tracer, cache)?;
                    let ok_result = parse_CharsetNeg(state, tracer, cache)?;
                    Ok(ok_result.map(|result| Parsed { neg: Some(result) }))
                }
                pub struct Parsed {
                    pub neg: Option<CharsetNeg>,
                }
            ...
            pub fn parse<'a>(
                ...
                match optional::parse(state.clone(), tracer, cache) {
                    Ok(ok_result) => Ok(ok_result.map(|result| Parsed { neg: result.neg })),
                    Err(err) => Ok(ParseOk { result: Parsed { neg: Default::default() }, state, farthest_error: Some(err) }),
                }
            }
            pub struct Parsed {
                pub neg: Option<CharsetNeg>,
        ...
        pub fn parse<'a>(
            ...
            Ok(ParseOk { result: Parsed { neg, items }, state, farthest_error })
        }
        pub struct Parsed {
            pub neg: Option<CharsetNeg>,
            pub items: Vec<CharItem>,
