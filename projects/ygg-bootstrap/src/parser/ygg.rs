...
// Hash of the grammar file: D4C231A8D68C10D153EEF0B09551E08284B6AEFD9F30880CEDC6A8DFD0DC2735
...
impl peginator_generated::PegParser for ProgramParser {
    fn parse_advanced<T: peginator_generated::ParseTracer>(s: &str, settings: &peginator_generated::ParseSettings) -> Result<Self, peginator_generated::ParseError> {
        Ok(peginator_generated::parse_ProgramParser(peginator_generated::ParseState::new(s, settings), T::new(), &mut Default::default())?.result)
    }
}
...
mod peginator_generated {
    ...
    mod ProgramParser_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::ProgramParser> {
            let result = parse(state, tracer, cache)?.map(|r| super::ProgramParser { program: r.program });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_ProgramParser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, ProgramParser> {
    ...
    mod ProgramNode_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::ProgramNode> {
    ...
    #[inline]
    pub(super) fn parse_ProgramNode<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, ProgramNode> {
    ...
    mod StatementNode_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::StatementNode> {
            let result = parse(state, tracer, cache)?.map(|result| result._override);
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_StatementNode<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, StatementNode> {
    ...
    mod DefineStatement_impl {
        ...
        mod part_4 {
            ...
            pub fn parse<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Parsed> {
                match optional::parse(state.clone(), tracer, cache) {
                    ...
                    Err(err) => Ok(ParseOk {
                        result: Parsed { arguments: Default::default() },
                        state,
        ...
        mod part_5 {
            ...
            pub fn parse<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Parsed> {
                match optional::parse(state.clone(), tracer, cache) {
                    ...
                    Err(err) => Ok(ParseOk {
                        result: Parsed { r#type: Default::default() },
                        state,
                        farthest_error: Some(err),
                    }),
                }
        ...
        pub fn parse<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Parsed> {
            ...
            Ok(ParseOk {
                result: Parsed { define, modifiers, symbol, arguments, r#type, body },
                state,
                farthest_error,
            })
        }
    ...
    mod DEFINE_impl {
        ...
        pub struct Parsed;
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, DEFINE> {
    ...
    mod MacroCalls_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::MacroCalls> {
            let result = parse(state, tracer, cache)?.map(|r| super::MacroCalls { macros: r.macros });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_MacroCalls<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, MacroCalls> {
    ...
    mod Macro_impl {
        ...
        mod part_1 {
            ...
            pub fn parse<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Parsed> {
                match optional::parse(state.clone(), tracer, cache) {
                    ...
                    Err(err) => Ok(ParseOk {
                        result: Parsed { args: Default::default() },
                        state,
                        farthest_error: Some(err),
                    }),
                }
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::Macro> {
            let result = parse(state, tracer, cache)?.map(|r| super::Macro { id: r.id, args: r.args });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_Macro<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Macro> {
    ...
    mod Boolean_impl {
        ...
        pub struct Parsed;
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Boolean> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|_, new_state| {
                let string = state.slice_until(new_state).to_string();
                string
            });
    ...
    #[inline]
    pub(super) fn parse_Boolean<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Boolean> {
    ...
    mod ArgumentValue_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, ArgumentValue> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|_, new_state| {
                let string = state.slice_until(new_state).to_string();
                string
            });
    ...
    #[inline]
    pub(super) fn parse_ArgumentValue<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, ArgumentValue> {
    ...
    #[inline]
    pub(super) fn parse_ChoiceNode<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, ChoiceNode> {
    ...
    mod Arguments_impl {
        ...
        pub struct Parsed;
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::Arguments> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::Arguments { position: state.range_until(new_state) });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_Arguments<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Arguments> {
    ...
    mod Typing_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::Typing> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::Typing { id: r.id, position: state.range_until(new_state) });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_Typing<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Typing> {
    ...
    mod Group_impl {
        ...
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::Group> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::Group { body: r.body, position: state.range_until(new_state) });
            Ok(result)
        }
    }
    #[inline]
    ...
    mod StringLiteral_impl {
        ...
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::StringLiteral> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|r, new_state| super::StringLiteral { body: r.body, position: state.range_until(new_state) });
            Ok(result)
        }
    }
    #[inline]
    ...
    mod StringEscaped_impl {
        ...
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, super::StringEscaped> {
            let result = parse(state, tracer, cache)?.map(|r| super::StringEscaped { char: r.char });
            Ok(result)
        }
    }
    #[inline]
    pub(super) fn parse_StringEscaped<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, StringEscaped> {
    ...
    mod Identifier_impl {
        ...
        pub struct Parsed;
        #[inline(always)]
        pub fn rule_parser<'a>(state: ParseState<'a>, tracer: impl ParseTracer, cache: &mut ParseCache<'a>) -> ParseResult<'a, Identifier> {
            let result = parse(state.clone(), tracer, cache)?.map_with_state(|_, new_state| {
                let string = state.slice_until(new_state).to_string();
