...
pub enum SyntaxKind {
    ...
    sym_regex_long = 59,
    sym_regex_range = 60,
    sym_regex_range_item = 61,
    sym_regex_range_item_group = 62,
    sym_regex_set = 63,
    aux_sym_program_repeat1 = 64,
    aux_sym__grammar_exts_repeat1 = 65,
    aux_sym__concat_expr_repeat1 = 66,
    aux_sym__or_expr_repeat1 = 67,
    aux_sym_macro_call_repeat1 = 68,
    aux_sym_regex_range_repeat1 = 69,
    alias_sym_concat_expr = 70,
    alias_sym_or_expr = 71,
}
