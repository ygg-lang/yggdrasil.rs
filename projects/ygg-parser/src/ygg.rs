// This file was generated by Peginator v0.6.0 built at 1669883490
// CRC-32/ISO-HDLC of the grammar file: 12f08b51
        ...
        mod choice_0 {
            ...
            pub fn parse<'a, TT: ParseTracer>(
                ...
                let ParseOk { result: _override, state } = parse_Whitespace(state, &mut *global)
                    .and_then(|ParseOk { state, .. }| parse_DefineStatement(state, global))
    ...
    mod Modifiers_impl {
        ...
        mod closure {
            ...
            pub fn parse<'a, TT: ParseTracer>(
                ...
                let ParseOk { result: mut id, state } = parse_Whitespace(state, &mut *global)
                    .and_then(|ParseOk { state, .. }| parse_Identifier(state, &mut *global))
                    .map_inner(|result| vec![result])?;
